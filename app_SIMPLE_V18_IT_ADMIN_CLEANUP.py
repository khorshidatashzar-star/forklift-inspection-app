...
def it_actions(u):
    ...
    tab_staff, tab_assets, tab_requests, tab_overview = st.tabs(
        ["👥 Staff Management", "🚜 Asset Management",
         "📍 Location Update Requests", "📊 System Overview"]
    )

    with tab_staff:
        st.subheader("Staff Management")
        st.caption("IT defines Name → Username → Role → Location when creating staff.")
        ...
        with st.form("it_add_staff_v18"):
            ...
            if role=="WH Manager":
                ...
                loc="ALL"
                st.caption("Location access: All Locations")
    ...
    with tab_requests:
        st.subheader("Location Update Requests")
        st.caption("Requests sent by Compliance when a serial already exists at another warehouse.")
